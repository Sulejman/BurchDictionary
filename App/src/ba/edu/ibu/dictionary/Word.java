...
public class Word implements Comparable<Word> {
	...
	public Word(String tr, String bs, String en, String tr_pr, String bs_pr,
			String tr_ph, String bs_ph, String en_ph, String tr_ph_bs_pr,
			String bs_ph_tr_pr) {
		KEY_TURKISH = tr;
		KEY_BOSNIAN = bs;
		KEY_ENGLISH = en;
	...
	public Word(String tr_ph, String bs_ph, String en_ph, String tr_ph_bs_pr,
			String bs_ph_tr_pr) {
		KEY_BOSNIAN_PHRASE = bs_ph;
		KEY_TURKISH_PHRASE = tr_ph;
		KEY_TURKISH_PHRASE_BOSNIAN_PRONUNCIATION = tr_ph_bs_pr;
	...
	public static class OrderByBosnian implements Comparator<Word> {
		...
		public int compare(Word arg0, Word arg1) {
			try {
				return bs_BSCollator
						.compare(arg0.KEY_BOSNIAN, arg1.KEY_BOSNIAN);
			} catch (NullPointerException e) {
				return 0;
			}
		}
	...
	public int compareTo(Word another) {
		return this.KEY_ROWID > another.KEY_ROWID ? 1
				: (this.KEY_ROWID < another.KEY_ROWID ? -1 : 0);
	}
