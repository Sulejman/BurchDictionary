...
public class WordAdapter extends BaseAdapter implements SectionIndexer {
	...
	public View getView(final int position, View view, ViewGroup parent) {
		...
		if (view == null) {
			...
			holder.textViewWord = (TextView) view
		...
		holder.textViewTrP.setText(wordList.get(position)
				.getBosnianPronunciation());
		holder.textViewBsP.setText(wordList.get(position)
				.getTurkishPronunciation());
